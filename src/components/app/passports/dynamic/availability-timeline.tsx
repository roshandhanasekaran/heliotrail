  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="grid flex-1 grid-cols-3 gap-4 pt-1">
          <div>
            ...
            <p className="text-[10px] text-muted-foreground/70">Mean time between failures</p>
          </div>
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/70">
              MTTR
            ...
            <p className="text-[10px] text-muted-foreground/70">Mean time to repair</p>
          </div>
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/70">
              Total Downtime
        ...
        <div className="space-y-1" onMouseLeave={() => setHoveredMonth(null)}>
          {data.map((d, i) => {
            ...
            return (
              ...
              >
                <span className="w-7 text-right font-mono text-[10px] text-muted-foreground/70">
                  {d.month}
                </span>
                ...
                <span
                  className={`w-16 text-right font-mono text-[10px] transition-colors ${
                    isHovered ? "text-foreground font-semibold" : "text-muted-foreground/70"
                  }`}
                >
      ...
      <div className="flex items-center gap-4 text-[10px] text-muted-foreground">
        ...
        <span className="flex items-center gap-1">
          <CheckCircle2 className="h-2.5 w-2.5 text-primary" /> No downtime
        </span>
      </div>
    </div>
  );
