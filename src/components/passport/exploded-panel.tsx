    ...
    <div className={cn("relative", className)}>
      ...
      <div className="flex justify-center mb-6">
        <button
          ...
          className="group flex items-center gap-2 rounded-full bg-muted px-5 py-2 text-xs font-medium transition-all hover:bg-primary/10 hover:text-primary"
        >
          <motion.span
                  ...
                  {isExploded && (
                    <>
                      <line
                        ...
                        stroke={layer.color} strokeWidth="0.3"
                  ...
                  {isExploded && isActive && (
                    <>
                      ...
                      <circle
                        ...
                        r="2" fill={layer.color} fillOpacity="0.6"
                      />
                    </>
                  )}
                </motion.g>
