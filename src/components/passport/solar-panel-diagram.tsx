...
export function SolarPanelDiagram({
  ...
  return (
    <div className="relative mx-auto max-w-md">
      ...
      >
        ...
        >
              ...
              return (
                <g key={`${row}-${col}`}>
                  ...
                  <line
                    x1={x} y1={y + 12}
                    x2={x + 46} y2={y + 12}
                    stroke="#D9D9D9" strokeWidth="0.2" opacity="0.5"
                  />
                  <line
                    x1={x} y1={y + 25}
                    x2={x + 46} y2={y + 25}
          ...
          <rect
            ...
            fill="#F2F2F2" stroke="#D9D9D9" strokeWidth="0.8"
          />
          <text
            x="160" y="27" textAnchor="middle"
            fill="#737373" className="text-[6px] font-medium tracking-wider"
          >
            J-BOX
          </text>
          ...
          {[
            ...
            <g key={i}>
              <circle cx={cx} cy={cy} r="4" fill="none" stroke="#D9D9D9" strokeWidth="1" />
          ...
          <text
            ...
            fill="#737373" className="text-[7px] font-mono tracking-widest"
          >
            {passport.model_id}
          </text>
        </svg>
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          <motion.div
            ...
            className="flex items-center gap-3 border border-[#D9D9D9] bg-white px-5 py-2 shadow-sm"
          >
            ...
            <div className="h-3 w-px bg-[#D9D9D9]" />
            <div className="flex items-center gap-1.5">
              <SunIcon className="h-3.5 w-3.5 text-[#0D0D0D]" />
      ...
      >
        <div className="flex items-center gap-2 bg-[#E8FAE9] border border-[#22C55E] px-4 py-1.5">
          <div className="h-2 w-2 bg-[#22C55E]" />
          <span className="text-xs font-medium text-[#0D0D0D]">
